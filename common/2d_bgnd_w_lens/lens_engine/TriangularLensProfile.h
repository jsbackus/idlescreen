...
/**
 * This profile creates an isosceles Triangular lens.
 */

#ifndef __TRIANGULARLENSPROFILE_H__
#define __TRIANGULARLENSPROFILE_H__

#include "LensProfile.h"

class TriangularLensProfile : public LensProfile {
public:
	TriangularLensProfile();
	~TriangularLensProfile();
