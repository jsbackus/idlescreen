...
/**
 * This profile creates an isosceles Diamond lens.
 */

#ifndef __DIAMONDLENSPROFILE_H__
#define __DIAMONDLENSPROFILE_H__

#include "LensProfile.h"

class DiamondLensProfile : public LensProfile {
public:
	DiamondLensProfile();
	~DiamondLensProfile();
