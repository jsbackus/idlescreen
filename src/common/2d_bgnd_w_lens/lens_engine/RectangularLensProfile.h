...
/**
 * This profile creates a rectangular lens.
 */

#ifndef __RECTANGULARLENSPROFILE_H__
#define __RECTANGULARLENSPROFILE_H__

#include "LensProfile.h"

class RectangularLensProfile : public LensProfile {
public:
	RectangularLensProfile();
	~RectangularLensProfile();
