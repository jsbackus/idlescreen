...
PlasmaGeneratorPaletteSelectWidget::PlasmaGeneratorPaletteSelectWidget(ConfigManager* confMgr, QWidget* parent, Qt::WindowFlags f) {
  QWidget(parent, f);
...
void PlasmaGeneratorPaletteSelectWidget::editPalette(const QString& palName, bool bReplace) {
  if(_confMgr == NULL || _list == NULL)
    return;
